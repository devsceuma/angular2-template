...
export class CustomValidators {
  ...
  static getErrorMessage(errorName: string, error?: any): string {
    let config = {
      ...
      'minlength': `Minimo de ${error.requiredLength} caracteres`,
      'maxlength': `Máximo de ${error.requiredLength} caracteres`,
      'noEmptyWhiteSpace': 'Contains empty white space',
      'invalidEmailAddress': 'Invalid email address',
      'invalidPassword': 'Não adicionar espaço por favor.', // Appropriate message for controlling regex
      'invalidUsername': 'Não adicionar espaços, números, ou caracteres especiais.', // Appropriate message for controlling regex
